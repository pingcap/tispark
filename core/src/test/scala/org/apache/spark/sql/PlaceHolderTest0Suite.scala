...
class PlaceHolderTest0Suite
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = null") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = null")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = null")
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 'PingCAP'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 'PingCAP'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 'PingCAP'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = '2017-11-02'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = '2017-11-02'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = '2017-11-02'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = '2017-10-30'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = '2017-10-30'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = '2017-10-30'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = '2017-09-07 11:11:11'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = '2017-09-07 11:11:11'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = '2017-09-07 11:11:11'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = '2017-11-02 08:47:43'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = '2017-11-02 08:47:43'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = '2017-11-02 08:47:43'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 'fYfSp'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 'fYfSp'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 'fYfSp'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 9223372036854775807") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 9223372036854775807")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 9223372036854775807")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = -9223372036854775808") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = -9223372036854775808")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = -9223372036854775808")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 1.7976931348623157E308") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 1.7976931348623157E308")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 1.7976931348623157E308")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 3.14159265358979") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 3.14159265358979")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 3.14159265358979")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 2.34E10") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 2.34E10")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 2.34E10")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 2147483647") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 2147483647")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 2147483647")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = -2147483648") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = -2147483648")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = -2147483648")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 32767") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 32767")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 32767")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = -32768") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = -32768")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = -32768")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 127") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 127")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 127")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = -128") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = -128")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = -128")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 0") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 0")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 0")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 2017") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 2017")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 2017")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_char = 2147868.65536") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_char = 2147868.65536")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_char = 2147868.65536")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = null") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = null")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = null")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 'PingCAP'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 'PingCAP'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 'PingCAP'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = '2017-11-02'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = '2017-11-02'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = '2017-11-02'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = '2017-10-30'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = '2017-10-30'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = '2017-10-30'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = '2017-09-07 11:11:11'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = '2017-09-07 11:11:11'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = '2017-09-07 11:11:11'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = '2017-11-02 08:47:43'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = '2017-11-02 08:47:43'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = '2017-11-02 08:47:43'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 'fYfSp'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 'fYfSp'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 'fYfSp'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 9223372036854775807") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 9223372036854775807")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 9223372036854775807")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = -9223372036854775808") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = -9223372036854775808")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = -9223372036854775808")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 1.7976931348623157E308") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 1.7976931348623157E308")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 1.7976931348623157E308")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 3.14159265358979") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 3.14159265358979")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 3.14159265358979")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 2.34E10") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 2.34E10")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 2.34E10")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 2147483647") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 2147483647")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 2147483647")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = -2147483648") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = -2147483648")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = -2147483648")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 32767") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 32767")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 32767")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = -32768") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = -32768")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = -32768")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 127") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 127")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 127")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = -128") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = -128")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = -128")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 0") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 0")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 0")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 2017") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 2017")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 2017")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_tinyint = 2147868.65536") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_tinyint = 2147868.65536")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_tinyint = 2147868.65536")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = null") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = null")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = null")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = '2017-11-02'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = '2017-11-02'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = '2017-11-02'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = '2017-10-30'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = '2017-10-30'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = '2017-10-30'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = '2017-09-07 11:11:11'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = '2017-09-07 11:11:11'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = '2017-09-07 11:11:11'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = '2017-11-02 08:47:43'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = '2017-11-02 08:47:43'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = '2017-11-02 08:47:43'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = 'fYfSp'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = 'fYfSp'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = 'fYfSp'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = 9223372036854775807") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = 9223372036854775807")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = 9223372036854775807")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = -9223372036854775808") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = -9223372036854775808")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = -9223372036854775808")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = 1.7976931348623157E308") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = 1.7976931348623157E308")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = 1.7976931348623157E308")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = 3.14159265358979") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = 3.14159265358979")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = 3.14159265358979")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = 2.34E10") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = 2.34E10")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = 2.34E10")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = 2147483647") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = 2147483647")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = 2147483647")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = -2147483648") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = -2147483648")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = -2147483648")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = 32767") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = 32767")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = 32767")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = -32768") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = -32768")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = -32768")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = 127") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = 127")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = 127")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = -128") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = -128")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = -128")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = 0") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = 0")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = 0")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = 2017") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = 2017")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = 2017")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_float = 2147868.65536") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_float = 2147868.65536")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_float = 2147868.65536")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_blob = null") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_blob = null")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_blob = null")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = null") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = null")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = null")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = '2017-11-02'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = '2017-11-02'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = '2017-11-02'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = '2017-10-30'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = '2017-10-30'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = '2017-10-30'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = '2017-09-07 11:11:11'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = '2017-09-07 11:11:11'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = '2017-09-07 11:11:11'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = '2017-11-02 08:47:43'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = '2017-11-02 08:47:43'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = '2017-11-02 08:47:43'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = 'fYfSp'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = 'fYfSp'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = 'fYfSp'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = 9223372036854775807") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = 9223372036854775807")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = 9223372036854775807")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = -9223372036854775808") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = -9223372036854775808")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = -9223372036854775808")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = 1.7976931348623157E308") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = 1.7976931348623157E308")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = 1.7976931348623157E308")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = 3.14159265358979") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = 3.14159265358979")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = 3.14159265358979")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = 2.34E10") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = 2.34E10")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = 2.34E10")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = 2147483647") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = 2147483647")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = 2147483647")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = -2147483648") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = -2147483648")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = -2147483648")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = 32767") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = 32767")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = 32767")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = -32768") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = -32768")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = -32768")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = 127") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = 127")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = 127")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = -128") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = -128")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = -128")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = 0") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = 0")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = 0")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = 2017") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = 2017")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = 2017")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where id_dt = 2147868.65536") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where id_dt = 2147868.65536")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where id_dt = 2147868.65536")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = null") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = null")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = null")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 'PingCAP'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 'PingCAP'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 'PingCAP'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = '2017-11-02'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = '2017-11-02'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = '2017-11-02'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = '2017-10-30'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = '2017-10-30'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = '2017-10-30'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = '2017-09-07 11:11:11'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = '2017-09-07 11:11:11'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = '2017-09-07 11:11:11'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = '2017-11-02 08:47:43'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = '2017-11-02 08:47:43'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = '2017-11-02 08:47:43'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 'fYfSp'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 'fYfSp'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 'fYfSp'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 9223372036854775807") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 9223372036854775807")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 9223372036854775807")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = -9223372036854775808") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = -9223372036854775808")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = -9223372036854775808")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 1.7976931348623157E308") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 1.7976931348623157E308")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 1.7976931348623157E308")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 3.14159265358979") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 3.14159265358979")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 3.14159265358979")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 2.34E10") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 2.34E10")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 2.34E10")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 2147483647") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 2147483647")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 2147483647")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = -2147483648") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = -2147483648")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = -2147483648")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 32767") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 32767")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 32767")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = -32768") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = -32768")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = -32768")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 127") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 127")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 127")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = -128") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = -128")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = -128")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 0") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 0")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 0")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 2017") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 2017")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 2017")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_bigint = 2147868.65536") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_bigint = 2147868.65536")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_bigint = 2147868.65536")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_double = null") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_double = null")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_double = null")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
  ...
  test("select  count(1)  from full_data_type_table  where tp_double = '2017-11-02'") {
    val r1 = querySpark("select  count(1)  from full_data_type_table  where tp_double = '2017-11-02'")
    val r2 = querySpark("select  count(1)  from full_data_type_table_j  where tp_double = '2017-11-02'")
    val result = compResult(r1, r2)
    if (!result) {
      fail(s"Failed with \nTiSpark:\t\t$r1\nSpark With JDBC:$r2")
    }
