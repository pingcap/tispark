...
/**
  * Created by birdstorm on 2018/4/16.
  */
class AlterTableTestSuite extends BaseTiSparkSuite {

  def alterTable(dataType: String, value: String, defaultVal: String, defaultVal2: String, nullable: Boolean = true, defaultNullOnly: Boolean = false): Unit = {
  ...
  test("Default value information not fetched") {
    ...
    alterTable("datetime", "\"2018-01-01 00:00:00\"", "\"2018-01-01 11:11:11\"", "\"2018-01-01 22:22:22\"")
    alterTable("date", "\"2018-01-01\"", "\"2018-02-02\"", "\"2018-03-03\"")
    alterTable("timestamp", "\"2018-01-01 00:00:00\"", "\"2018-01-01 11:11:11\"", "\"2018-01-01 22:22:22\"", nullable = false)
    alterTable("bigint", "9223372036854775807", "-9223372036854775808", "1")
    alterTable("decimal", "1.7976931348623157E308", "0.7976931348623157E308", "-0.7976931348623157E308")
