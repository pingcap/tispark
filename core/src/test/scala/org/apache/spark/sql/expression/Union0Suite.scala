...
class Union0Suite
  ...
  test("(select tp_decimal from full_data_type_table where tp_decimal < 0) union (select tp_decimal from full_data_type_table where tp_decimal > 0) order by tp_decimal") {
    runTest("(select tp_decimal from full_data_type_table where tp_decimal < 0) union (select tp_decimal from full_data_type_table where tp_decimal > 0) order by tp_decimal",
  ...
  test("(select tp_smallint from full_data_type_table where tp_smallint < 0) union (select tp_smallint from full_data_type_table where tp_smallint > 0) order by tp_smallint") {
    runTest("(select tp_smallint from full_data_type_table where tp_smallint < 0) union (select tp_smallint from full_data_type_table where tp_smallint > 0) order by tp_smallint",
  ...
  test("(select id_dt from full_data_type_table where id_dt < 0) union (select id_dt from full_data_type_table where id_dt > 0) order by id_dt") {
    runTest("(select id_dt from full_data_type_table where id_dt < 0) union (select id_dt from full_data_type_table where id_dt > 0) order by id_dt",
  ...
  test("(select tp_int from full_data_type_table where tp_int < 0) union (select tp_int from full_data_type_table where tp_int > 0) order by tp_int") {
    runTest("(select tp_int from full_data_type_table where tp_int < 0) union (select tp_int from full_data_type_table where tp_int > 0) order by tp_int",
  ...
  test("(select tp_bigint from full_data_type_table where tp_bigint < 0) union (select tp_bigint from full_data_type_table where tp_bigint > 0) order by tp_bigint") {
    runTest("(select tp_bigint from full_data_type_table where tp_bigint < 0) union (select tp_bigint from full_data_type_table where tp_bigint > 0) order by tp_bigint",
  ...
  test("(select tp_mediumint from full_data_type_table where tp_mediumint < 0) union (select tp_mediumint from full_data_type_table where tp_mediumint > 0) order by tp_mediumint") {
    runTest("(select tp_mediumint from full_data_type_table where tp_mediumint < 0) union (select tp_mediumint from full_data_type_table where tp_mediumint > 0) order by tp_mediumint",
  ...
  test("(select tp_real from full_data_type_table where tp_real < 0) union (select tp_real from full_data_type_table where tp_real > 0) order by tp_real") {
    runTest("(select tp_real from full_data_type_table where tp_real < 0) union (select tp_real from full_data_type_table where tp_real > 0) order by tp_real",
  ...
  test("(select tp_float from full_data_type_table where tp_float < 0) union (select tp_float from full_data_type_table where tp_float > 0) order by tp_float") {
    runTest("(select tp_float from full_data_type_table where tp_float < 0) union (select tp_float from full_data_type_table where tp_float > 0) order by tp_float",
  ...
  test("(select tp_double from full_data_type_table where tp_double < 0) union (select tp_double from full_data_type_table where tp_double > 0) order by tp_double") {
    runTest("(select tp_double from full_data_type_table where tp_double < 0) union (select tp_double from full_data_type_table where tp_double > 0) order by tp_double",
  ...
  test("(select tp_tinyint from full_data_type_table where tp_tinyint < 0) union (select tp_tinyint from full_data_type_table where tp_tinyint > 0) order by tp_tinyint") {
    runTest("(select tp_tinyint from full_data_type_table where tp_tinyint < 0) union (select tp_tinyint from full_data_type_table where tp_tinyint > 0) order by tp_tinyint",
