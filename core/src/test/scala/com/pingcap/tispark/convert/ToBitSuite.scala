  ...
  test("Test Convert from java.lang.Boolean to BIT") {
    ...
    compareTiDBWriteWithJDBC {
      case (writeFunc, _) =>
        ...
        val readRow2 = Row(2, false, toBytes(1), toBytes(0, 0, 0, 0, 0, 0, 0, 0))
        val readRow3 = Row(3, true, toBytes(0), toBytes(0, 0, 0, 0, 0, 0, 0, 1))
        val readRow4 = Row(4, false, toBytes(0), toBytes(0, 0, 0, 0, 0, 0, 0, 0))
        val readRow5 = Row(5, true, toBytes(1), toBytes(0, 0, 0, 0, 0, 0, 0, 1))
  ...
  test("Test Convert from java.lang.Byte to BIT") {
    ...
    compareTiDBWriteWithJDBC {
      case (writeFunc, _) =>
        ...
        val readRow1 = Row(1, null, null, null)
        val readRow2 = Row(2, false, toBytes(22), toBytes(0, 0, 0, 0, 0, 0, 0, 11))
        val readRow3 = Row(3, true, toBytes(11), toBytes(0, 0, 0, 0, 0, 0, 0, 22))
        val readRow4 = Row(4, false, toBytes(11), toBytes(0, 0, 0, 0, 0, 0, 0, 127))
        val readRow5 = Row(5, true, toBytes(22), toBytes(0, 0, 0, 0, 0, 0, 0, 102))
  ...
  test("Test Convert from java.lang.Short to BIT") {
    ...
    compareTiDBWriteWithJDBC {
      case (writeFunc, _) =>
        ...
        val readRow2 = Row(2, false, toBytes(22), toBytes(0, 0, 0, 0, 0, 0, 0, 11))
        val readRow3 = Row(3, true, toBytes(11), toBytes(0, 0, 0, 0, 0, 0, 0, 22))
        val readRow4 = Row(4, false, toBytes(11), toBytes(0, 0, 0, 0, 0, 0, 127, 255))
        val readRow5 = Row(5, true, toBytes(22), toBytes(0, 0, 0, 0, 0, 0, 0, 102))
  ...
  test("Test Convert from java.lang.Integer to BIT") {
    ...
    compareTiDBWriteWithJDBC {
      case (writeFunc, _) =>
        ...
        val readRow2 = Row(2, false, toBytes(22), toBytes(0, 0, 0, 0, 0, 0, 0, 11))
        val readRow3 = Row(3, true, toBytes(11), toBytes(0, 0, 0, 0, 0, 0, 0, 22))
        val readRow4 = Row(4, false, toBytes(11), toBytes(0, 0, 0, 0, 127, 255, 255, 255))
        val readRow5 = Row(5, true, toBytes(22), toBytes(0, 0, 0, 0, 0, 0, 0, 102))
  ...
  test("Test Convert from java.lang.Long to BIT") {
    ...
    compareTiDBWriteWithJDBC {
      case (writeFunc, _) =>
        ...
        val readRow2 = Row(2, false, toBytes(22), toBytes(0, 0, 0, 0, 0, 0, 0, 11))
        val readRow3 = Row(3, true, toBytes(11), toBytes(0, 0, 0, 0, 0, 0, 0, 22))
        val readRow4 = Row(4, false, toBytes(11), toBytes(127, 255, 255, 255, 255, 255, 255, 255))
        val readRow5 = Row(5, true, toBytes(22), toBytes(0, 0, 0, 0, 0, 0, 0, 102))
  ...
  test("Test Convert from java.lang.Float to BIT") {
    ...
    compareTiDBWriteWithJDBC {
      case (writeFunc, _) =>
        ...
        val readRow1 = Row(1, null, null, null)
        val readRow2 = Row(2, false, toBytes(2), toBytes(0, 0, 0, 0, 0, 0, 13, 72))
        val readRow3 = Row(3, true, toBytes(1), toBytes(0, 0, 0, 0, 0, 0, 0, 0))
        val readRow4 = Row(4, false, toBytes(1), toBytes(0, 0, 0, 0, 0, 0, 0, 1))
        val readRow5 = Row(5, true, toBytes(2), toBytes(0, 0, 0, 0, 0, 0, 0, 2))
  ...
  test("Test Convert from java.lang.Double to BIT") {
    ...
    compareTiDBWriteWithJDBC {
      case (writeFunc, _) =>
        ...
        val readRow1 = Row(1, null, null, null)
        val readRow2 = Row(2, false, toBytes(2), toBytes(0, 0, 0, 0, 0, 0, 7, 6))
        val readRow3 = Row(3, true, toBytes(1), toBytes(0, 0, 0, 0, 0, 0, 0, 0))
        val readRow4 = Row(4, false, toBytes(1), toBytes(0, 0, 0, 0, 0, 0, 0, 1))
        val readRow5 = Row(5, true, toBytes(2), toBytes(0, 0, 0, 0, 0, 0, 0, 2))
