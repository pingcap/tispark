...
class PartitionWriteSuite extends BaseTiSparkTest {
  ...
  test("test Year() range partition when date type is not the first column") {
    ...
    val data: RDD[Row] = sc.makeRDD(
      List(
        Row("Luo", Date.valueOf("2002-09-01"), Date.valueOf("1995-06-15")),
        Row("John", Date.valueOf("2002-09-01"), Date.valueOf("1995-08-08")),
        Row("Jack", Date.valueOf("2002-09-01"), Date.valueOf("1993-08-22")),
        Row("Mike", Date.valueOf("2002-09-01"), Date.valueOf("1999-06-04"))))
    val schema: StructType =
      StructType(
        List(
    ...
    checkPartitionJDBCResult(
      Map(
        "p0" -> Array(Array("Jack", Date.valueOf("2002-09-01"), Date.valueOf("1993-08-22"))),
        "p1" -> Array(
          Array("Luo", Date.valueOf("2002-09-01"), Date.valueOf("1995-06-15")),
          Array("John", Date.valueOf("2002-09-01"), Date.valueOf("1995-08-08"))),
        "p2" -> Array(Array("Mike", Date.valueOf("2002-09-01"), Date.valueOf("1999-06-04")))))
    spark.sql(
      s"delete from `tidb_catalog`.`$database`.`$table` where birthday <= '1995-06-15' or name = 'Mike'")
