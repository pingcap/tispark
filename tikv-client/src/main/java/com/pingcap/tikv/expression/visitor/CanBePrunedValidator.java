...
public class CanBePrunedValidator extends DefaultVisitor<Void, PartPruningContext> {
  public static class PartPruningContext {
    Expression partExpr;
    boolean foundOR;
    boolean orWithUnrelatedCol;
    Set<Expression> seenCOlRefs;

    public PartPruningContext(Expression partExpr) {
  ...
  public static boolean canBePruned(Expression node, PartPruningContext contextPartExpr) {
  ...
  @Override
  protected Void visit(LogicalBinaryExpression lbe, PartPruningContext contextPartExpr) {
  ...
  @Override
  protected Void visit(ColumnRef colRef, PartPruningContext contextPartExpr) {
  ...
  @Override
  protected Void process(Expression node, PartPruningContext partExpr) {
