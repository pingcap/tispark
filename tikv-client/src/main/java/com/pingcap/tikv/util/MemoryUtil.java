...
public class MemoryUtil {
  ...
  public static BlockReader getDFSInputStream_blockReader(Object br) {
    return (BlockReader) unsafe.getObject(br, DFSInputStream_blockReader);
  }

  public static boolean getDFSInputStream_verifyChecksum(Object br) {
    return unsafe.getBoolean(br, DFSInputStream_verifyChecksum);
  }

  public static void setDFSInputStream_verifyChecksum(Object br, boolean value) {
    unsafe.putBoolean(br, DFSInputStream_verifyChecksum, value);
  }
