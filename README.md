...
| spark.tispark.plan.preferred_indices |  "" | A comma separated list of index name. User might specify this item to make planner choose specified indices. If multiple specified, TiSpark will choose based on cost. |
