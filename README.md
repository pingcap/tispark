...
| spark.tispark.type.unsupported_mysql_types |  "time,enum,set" | A comma separated list of mysql types TiSpark does not support currently, refer to `Unsupported MySQL Type List` below |
