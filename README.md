...
| `spark.tispark.tikv.tls_enable`                             | `false`          | Whether to enable TiSpark TLS. When open TLS, `spark.sql.catalog.tidb_catalog.tikv.tls_enable` and `spark.tispark.enableJDBCSSL` must also be enabled.                                                                                                                                                                |
...
| `spark.sql.catalog.tidb_catalog.tikv.tls_enable`            | `false`          | Whether to enable TiSpark TLS for catalog.                                                                                                                                                                                                                                                                            |
| `spark.sql.catalog.tidb_catalog.tikv.trust_cert_collection` | ``               | The same as `spark.tispark.tikv.trust_cert_collection`, e.g. `/home/tispark/config/root.crt`.                                                                                                                                                                                                                         |
| `spark.sql.catalog.tidb_catalog.tikv.key_cert_chain`        | ``               | The same as `spark.tispark.tikv.key_cert_chain`, e.g. `/home/tispark/config/client.crt`.                                                                                                                                                                                                                               |
