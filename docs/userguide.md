...
Download the TiSpark's jar package [here](http://download.pingcap.org/tispark-${version}-jar-with-dependencies.jar).
...
```
Spark-shell --jars $ PATH / tispark-core-1.1-jar-with-dependencies.jar
```
