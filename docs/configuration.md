...
| `spark.tispark.tikv.host_mapping`               | ``               | This is route map used to configure public IP and intranet IP mapping.The format is `{Intranet IP}:{Public IP}`, e.g. `127.0.0.1:192.168.100.100`.                                                                                                                                                                    |
